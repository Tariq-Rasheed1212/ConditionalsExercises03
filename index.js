...
if (fuelLevel > 20000 && engineTemperature < 2500) {
  ...
  (fuelLevel > 10000 && engineTemperature < 2500){
    console.log("Fuel level above 50%. Engines good.")
  }  else if 
  (fuelLevel > 5000 || engineTemperature <= 2500) {
    console.log("Check fuel level. Egines running hot.")
  } else if
  (fuelLevel < 1000 || engineTemperature > 3500 || engineIndicatorLight === 'red blinking') {
